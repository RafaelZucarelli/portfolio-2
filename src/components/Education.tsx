    ...
    >
      <div className="container align-self-center">
        <div className="row">
          ...
          >
            <h3 className="display-8 mb-3 py-4 text-center mt-4">
          ...
          <ul className="education">
            ...
            <h5 className="text-light mb-4">
              ...
              <span>- Faculdade Instituto Superior do Litoral do Paraná </span>
            </h5>
            <div className="year text-light ">
              <p>
            ...
            <h5 className="text-light">
              Curso em Desenvolvimento Web <span>- Udemy</span>
            </h5>
          </ul>
        </div>
      </div>
